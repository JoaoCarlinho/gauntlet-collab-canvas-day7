...
class ObjectValidationService {
  ...
  private initializeObjectTypeDefinitions(): void {
    ...
    this.objectTypeDefinitions.set('line', {
      ...
      propertyConstraints: new Map([
        ['x1', { type: 'number', required: true, description: 'X coordinate of start point' }],
        ['y1', { type: 'number', required: true, description: 'Y coordinate of start point' }],
        ['x2', { type: 'number', required: true, description: 'X coordinate of end point' }],
        ['y2', { type: 'number', required: true, description: 'Y coordinate of end point' }],
